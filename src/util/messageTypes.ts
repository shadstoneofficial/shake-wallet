enum MessageTypes {
  ...
  CREATE_FINALIZE = "create_finalize",
  ...
  GET_SECURITY_LOCK_TIMEOUT = "get_security_lock_timeout",
  GET_SHAKEDEX_CHANNEL = "get_shakedex_channel",
  GET_MULTI_ACCOUNTS_ENABLED = "getMultiAccountsEnabled",
  SET_ANALYTICS = "setAnalytics",
  SET_EXPLORER = "set_explorer",
  SET_SECURITY_LOCK_TIMEOUT = "set_security_lock_timeout",
  SET_SHAKEDEX_CHANNEL = "set_shakedex_channel",
  ...
  SEND_SHAKEDEX_FINALIZE = "send_shakedex_finalize",
